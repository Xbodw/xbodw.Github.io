...
$(document).ready(function() {
  ...
  function addRequestMessage(message) {
    ...
    let responseMessageElement = $('<br><br><div class="row message-bubble"><div class="message-text response"><span class="loading-icon"></span></div></div><br>');
  ...
  chatBtn.click(function() {
    ...
    // 淇濆瓨api key涓庡璇濇暟鎹 
    let data = {
      "apiKey" : "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", // 杩欓噷濉啓鍥哄畾 apiKey
    }
