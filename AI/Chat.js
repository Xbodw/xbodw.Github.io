...
$(document).ready(function() {
  ...
  function addRequestMessage(message) {
    ...
    let responseMessageElement = $('<br><br><div class="row message-bubble"><img class="chatGPT" src="ChatGPT.png"><span>&nbsp;Flutas ChatGPT AI<div class="message-text response"><p>Reposeing...</p></div></div><br><br><br>');
